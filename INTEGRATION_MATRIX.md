...
| GitHub repo | Gabriel profile or verified `gh` account | GitHub auth | Public repo `https://github.com/gabrielantonyxaviour/x-cup-passport`; local `main` pushed to `origin/main` | No fixture | tested | None for repo; form still needs final field entry |
